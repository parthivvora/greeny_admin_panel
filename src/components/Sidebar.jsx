      ...
      <div className="sidebar-wrapper active">
        <div className="sidebar-header" style={{ marginBottom: "-1.5rem" }}>
          <h1>
            <a
              href="/"
              style={{ color: "#55BEFF", fontWeight: "bold", fontSize: 50 }}
            >
              Admin
            </a>
          </h1>
        ...
        <div className="sidebar-menu">
          <ul className="menu">
            ...
            <li
              className={`sidebar-item ${pathname === "/user" ? "active" : ""}`}
            >
            ...
            <li
              className={`sidebar-item ${
                pathname === "/product-review" ? "active" : ""
              }`}
            >
              <a href="/product-review" className="sidebar-link">
                <span>Product Review</span>
              </a>
            </li>
            <li
              className={`sidebar-item ${
                pathname === "/blog-comments" ? "active" : ""
              }`}
            >
              <a href="/blog-comments" className="sidebar-link">
